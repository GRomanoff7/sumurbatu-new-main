  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="PT Sumur Batu - Official Silver System Integrator for Rockwell Automation. Specialists in Control System Design, PLC Programming, and Industrial Automation Solutions." />
          ...
          <nav class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
              ...
              <div class="hidden lg:flex space-x-8">
                ...
                <a href="/industries" class="text-gray-700 hover:text-primary font-medium transition-colors">Industries</a>
                <a href="/products" class="text-gray-700 hover:text-primary font-medium transition-colors">Products</a>
                <a href="/contact" class="text-gray-700 hover:text-primary font-medium transition-colors">Contact Us</a>
              </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
              ...
              <div class="md:col-span-2">
                ...
                <p class="text-gray-300 mb-4">
                  ...
                  Your partner in automation and drives system engineering since 2007.
                </p>
              ...
              <div>
                ...
                <div class="space-y-2 text-gray-300">
                  <p><i class="fas fa-map-marker-alt mr-2"></i>Surabaya, East Java</p>
                  <p><i class="fas fa-phone mr-2"></i>+62-31-879.8168</p>
                  <p><i class="fas fa-envelope mr-1"></i>SumurBatu@gmail.com</p>
                </div>
              </div>
            </div>

            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
              <p>&copy; 2024 PT Sumur Batu. All rights reserved. | Silver System Integrator Partner of Rockwell Automation</p>
            </div>
          </div>
        </footer>
